<template>
  <div class="about">
    ...
    <div class="studies">
      <h3><li>Estudios</li></h3>
      <ul>
        <li><b>Formación de Desarrollo Web</b> -<i> Marzo 2022 a Junio 2022</i>
          Este curso intensivo proporcionó una base sólida en los fundamentos del desarrollo web, cubriendo temas como <b>HTML, CSS, y JavaScript</b>. Además, se exploraron conceptos avanzados de <b>Node.js</b> para la creación de aplicaciones web dinámicas y escalables.
        </li>
        <br>
        <li><b>Curso de Vue.js de Básico a Avanzado</b> -<i> Mayo 2022 a Julio 2022</i>
          Durante este curso, adquirí un profundo conocimiento de Vue.js, desde los conceptos básicos hasta técnicas avanzadas de desarrollo. Aprendí a construir aplicaciones web interactivas y dinámicas utilizando el poderoso framework Vue.js.
        </li>
        <br>
    ...
    <div class="skills">
      <h3><li>Habilidades Desarrolladas :</li></h3>
      <div class="skill">
        <h4>Diseño y Desarrollo <i class="fas fa-code"></i></h4>
      ...
      <div class="skill">
        <h4>Manejo de Base de Datos <i class="fas fa-server"></i></h4>
        <div class="progress-bar">
      ...
      <div class="skill">
        <h4>Frameworks y Librerías Modernas <i class="fas fa-cogs"></i></h4>
        <div class="progress-bar">
          <div class="progress" style="width: 60%;">60%</div>
        </div>
        <br>
        <div class="technologies">
          <div class="technology"><li> Vue.js <i class="fab fa-vuejs"></i></li></div>
          <div class="technology"><li> React <i class="fab fa-react"></i></li></div>
          <div class="technology"><li> Angular <i class="fab fa-angular"></i></li></div>
      ...
      <div class="skill">
        <h4>Herramientas Controles de Version <i class="fas fa-code-branch"></i></h4>
        <div class="progress-bar">
          <div class="progress" style="width: 40%;">40%</div>
        </div>
        <br>
        <div class="technologies">
          <div class="technology"><li> github <i class="fab fa-github"></i></li></div>
          <div class="technology"><li> git <i class="fab fa-git"></i></li></div>
        </div>
      </div>
    </div>
    ...
    <div class="goals">
      ...
      <p>
        Mi objetivo es seguir desarrollando mis habilidades como desarrollador web y contribuir a proyectos que tengan un impacto positivo. Estoy constantemente buscando oportunidades para aprender nuevas tecnologías y mejorar mis capacidades. Creo en el poder de la tecnología para transformar ideas en realidad y estoy comprometido a ser parte de esa transformación.
      </p>
    </div>

    <div class="contact">
      <h3><li>Contacto y Colaboración</li></h3>
      <p>
        Si estás interesado en colaborar o tienes un proyecto que crees que se beneficiaría de mis habilidades, no dudes en contactarme. Estoy abierto a nuevas oportunidades y emocionado por explorar el vasto mundo del desarrollo web.
      </p>
    </div>
  </div>
</template>
...
.skill {
  flex: 0 0 48%; /* Ocupa aproximadamente la mitad del ancho del contenedor */
  box-sizing: border-box; /* Incluye el padding y border en el ancho total */
  margin-bottom: 20px; /* Espacio inferior entre habilidades */
}

.progress-bar {
  height: 15px; /* Altura de la barra de progreso */
  background-color: #cfcbcb; /* Color de fondo de la barra */
  border-radius: 10px; /* Bordes redondeados */
  overflow: hidden;
  margin-top: 10px; /* Espacio superior respecto al título */
}

.progress {
  height: 100%;
  background: linear-gradient(45deg, rgb(6, 194, 153), #4ac36e); /* Gradiente de color para la barra de progreso */
  border-radius: 10px; /* Bordes redondeados */
  text-align: right; /* Texto alineado a la derecha */
  padding-right: 5px; /* Espacio a la derecha del texto */
  color: white;
  font-weight: bold;
...
.progress:hover {
  filter: brightness(1.2); /* Ilumina la barra al pasar el ratón */
  transition: filter 0.3s ease;
}
.technology:hover {
  background: #ccc; /* Cambia el color de fondo al pasar el ratón */
...
.technologies {
  display: flex;
  flex-wrap: wrap;
  gap: 10px; /* Espacio entre tecnologías */
  justify-content: center;
}

.technology {
  background: #e0e0e0; /* Fondo de la tecnología */
  border-radius: 5px; /* Bordes redondeados */
  padding: 5px 10px; /* Espacio interno del contenedor de tecnología */
  margin-top: 5px; /* Espacio superior respecto a la barra de progreso */
  display: inline-flex; /* Flexbox para la tecnología */
  align-items: center; /* Centrar ícono y texto */
  justify-content: center; /* Centrar ícono y texto */
}

@media (max-width: 600px) {
  .skill {
    flex: 0 0 100%; /* Habilidades en una sola columna en pantallas pequeñas */
  }
  .about {
    padding: 1rem;
  }
